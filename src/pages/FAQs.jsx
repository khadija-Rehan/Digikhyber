            ...
            <div className="container faq pt-5 pb-5">
                ...
                <Accordion defaultActiveKey="0">
                    ...
                    <Accordion.Item eventKey="9">
                        ...
                        <Accordion.Body>
                            <div className="p-3">
                                No, the Scholarship Card is provided <b>completely free of charge</b>
                    ...
                    <Accordion.Item eventKey="11">
                        ...
                        <Accordion.Body>
                            <div className="p-3">
                                The Laptop Scheme is an initiative by <b>  Hunarmand Punjab </b> to
                                provide eligible trainees with laptops to support their learning
                                in IT and technical courses.
                            </div>
                        </Accordion.Body>
                    </Accordion.Item>
                        ...
                        <Accordion.Body>
                            <div className="p-3">
                                ...
                                <ul>
                                    ...
                                    <li>Score minimum <b> 85% Marks in Final Evaluation Test</b></li>
                                    <li>
                    ...
                    <Accordion.Item eventKey="13">
                        ...
                        <Accordion.Body>
                            <div className="p-3">
                                Laptops are distributed <b> free of cost</b> to selected, eligible
                                students who meet the criteria. One time processing fee is
                                charged per course.
                            </div>
                        </Accordion.Body>
                    </Accordion.Item>
                    ...
                    <Accordion.Item eventKey="16">
                        ...
                        <Accordion.Body>
                            <div className="p-3">
                               ...
                               <b> Hunarmand Punjab </b> aimed at providing solar panels to eligible
                                trainees to support their access to continuous, affordable
                                electricity for learning and home use.
                            </div>
                        </Accordion.Body>
                    </Accordion.Item>
                    ...
                    <Accordion.Item eventKey="17">
                        ...
                        <Accordion.Body>
                            <div className="p-3">
                                ...
                                <ul>
                                    <li>
                                        Be enrolled in a current <b> Hunarmand Punjab training program</b>
                                    </li>
                                    <li>Score minimum <b> 85% Marks in Final Evaluation Test</b></li>
                                    <li>
                                        Show satisfactory performance in assignments, assessments &
                    ...
                    <Accordion.Item eventKey="18">
                        ...
                        <Accordion.Body>
                            <div className="p-3">
                                The solar panel is provided <b> completely free of cost </b>to eligible
                                and selected trainees who meet the criteria. One time processing
                    ...
                    <Accordion.Item eventKey="20">
                        ...
                        <Accordion.Body>
                            <div className="p-3">
                                Taleem Finance is a financial support program by <b> Hunarmand
                                Punjab </b> designed to assist trainees who may face financial
                                challenges in accessing quality Higher Education.
                            </div>
                        </Accordion.Body>
                    </Accordion.Item>
                    ...
                    <Accordion.Item eventKey="23">
                        ...
                        <Accordion.Body>
                            <div className="p-3">
                                In most cases, it is a <b> scholarship or grant</b> . In some advanced
                                certification programs,<b> loans</b> may be offered with easy repayment
                                options.
                            </div>
                        </Accordion.Body>
                    </Accordion.Item>
                        ...
                        <Accordion.Body>
                            <div className="p-3">
                                ...
                                <ul>
                                    ...
                                    <li>Filling the <b> Taleem Finance Application Form</b></li>
                                    <li>
                    ...
                    <Accordion.Item eventKey="26">
                        ...
                        <Accordion.Body>
                            <div className="p-3">
                                <ul>
                                    <li> <b>Email:</b> info@hunarmandpunjab.pk</li>
                                    <li>
                                       <b> Website:</b>{" "}
                                        <a
                                            href="https://www.hunarmandpunjab.pk"
