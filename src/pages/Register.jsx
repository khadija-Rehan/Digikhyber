...
const Register = () => {
  ...
  return (
    <div className="register">
      ...
      <form onSubmit={handleSubmit} className="register-inner">
        ...
        <center>
          <button
            type="button"
            className="btn btn-success fw-bold hbtn text-white p-3 rounded-cus"
          >
        ...
        <div className="mb-3">
          <div className="form-check">
            ...
            <label className="form-check-label" htmlFor="agreement">
              ...
              SSDP program. <span className="text-danger">*</span>
            </label>
            {errors.agreement && (
